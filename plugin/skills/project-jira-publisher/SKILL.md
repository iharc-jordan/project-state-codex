...
description: "Project Project State entities idempotently to Jira only when surfaces.jira is configured and available or the operator explicitly requests Jira setup/publishing. Always produce a dry-run preview and obtain confirmation before issue creation or updates. Keep credentials outside the substrate and write returned keys through project-state; never activate from a Jira keyword alone."
---
